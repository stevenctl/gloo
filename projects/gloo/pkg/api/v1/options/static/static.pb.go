...
type UpstreamSpec struct {
	...
	// traffic.
	InMesh bool `protobuf:"varint,7,opt,name=in_mesh,json=inMesh,proto3" json:"in_mesh,omitempty"`
}
...
func (x *UpstreamSpec) GetInMesh() bool {
	if x != nil {
		return x.InMesh
	}
	return false
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_static_static_proto_rawDesc = []byte{
	...
	0x65, 0x77, 0x72, 0x69, 0x74, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x6e, 0x5f, 0x6d, 0x65, 0x73,
	0x68, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x69, 0x6e, 0x4d, 0x65, 0x73, 0x68, 0x22,
